...
public class Univers {
	...
	private BranchGroup environment, root;
	...
	public Univers() {
		this(new Color3f(0, 0, 0));
	}
	public Univers(Color3f bgColor) {
	...
	private void createEnvironment(Color3f bgColor) {
