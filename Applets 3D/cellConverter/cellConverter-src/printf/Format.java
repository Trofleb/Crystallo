...
public class Format extends a {
	...
	private static void a(printf.c c1, java.lang.Object obj) {
		...
		if (c1._fldbyte == 11)
			flag = true;
		else if (c1._fldbyte == 2 || c1._fldbyte == 3 || c1._fldbyte == 4 || c1._fldbyte == 1 || c1._fldbyte == 8
				|| c1._fldbyte == 6 || c1._fldbyte == 9)
			flag = (obj instanceof java.lang.Boolean) || (obj instanceof java.lang.Character)
					|| (obj instanceof java.lang.Byte) || (obj instanceof java.lang.Short)
					|| (obj instanceof java.lang.Integer) || (obj instanceof java.lang.Long)
					|| (obj instanceof java.lang.Float) || (obj instanceof java.lang.Double);
		else if (c1._fldbyte == 12)
			flag = (obj instanceof java.lang.Boolean) || (obj instanceof java.lang.Byte)
					|| (obj instanceof java.lang.Short) || (obj instanceof java.lang.Integer)
			...
			flag = (obj instanceof java.lang.Byte) || (obj instanceof java.lang.Short)
	...
	public static java.lang.String sprintf(java.lang.String s, java.util.Vector vector)
		...
		synchronized (_fldnull) {
			...
			for (int j = 0; j < vector1.size(); j++) {
				...
				printf.Format.a(c2);
				printf.Format._mthif(c2);
				printf.Format._mthdo(c2);
				...
				if (c2._fldbyte == 11) {
					...
					if (obj2 instanceof java.lang.Character)
						...
						if (l2 < 0L)
							l2 += 256L;
					} else if (obj2 instanceof java.lang.Short) {
						...
						if (obj2 instanceof java.lang.Long) {
							...
							throw new ClassCastException(
									"Convertion of a long into an unsigned long is not supported: " + l2 + "l");
						}
	...
	public static void printf(java.lang.String s, java.util.Vector vector) throws printf.ParseErrorException {
		java.lang.System.out.print(printf.Format.sprintf(s, vector));
	}

	public static void printf(java.lang.String s, printf.Parameters parameters) throws printf.ParseErrorException {
		java.lang.System.out.print(printf.Format.sprintf(s, parameters));
	}

	public static void printf(java.lang.String s, java.lang.Object aobj[]) throws printf.ParseErrorException {
		java.lang.System.out.print(printf.Format.sprintf(s, aobj));
	}

	public static void printf(java.lang.String s) throws printf.ParseErrorException {
	...
	protected static printf.Parameters a(java.lang.String as[], int i) throws java.lang.Exception {
		...
		for (int j = 0; j < vector.size(); j++) {
			...
			if (c1.g == -1) {
				parameters.add(((java.lang.Long.valueOf(s))));
				i++;
			}
			if (c1.m == -1) {
				parameters.add(((java.lang.Long.valueOf(s))));
			...
			if (c1._fldbyte == 12)
				try {
					parameters.add(((java.lang.Integer.valueOf(s))));
				} catch (java.lang.NumberFormatException numberformatexception) {
					parameters.add(((java.lang.Boolean.valueOf(s))));
				}
			else if (c1._fldbyte == 1)
				try {
					if (s.length() != 1)
						parameters.add(((java.lang.Double.valueOf(s))));
					else
				...
				try {
					s = s.substring(0, k - 1);
					if (c2 == 'b')
						parameters.add(((java.lang.Byte.valueOf(s))));
					else if (c2 == 's')
						parameters.add(((java.lang.Short.valueOf(s))));
					else if (c2 == 'i')
						parameters.add(((java.lang.Integer.valueOf(s))));
					else if (c2 == 'l')
						parameters.add(((java.lang.Long.valueOf(s))));
...
class c {
	...
	public java.lang.String _mthif() {
		...
		switch (this.g) {
			...
			default:
				s1 = java.lang.String.valueOf(this.g);
				break;
		}
		return s1;
	}
	...
	public java.lang.String _mthdo() {
		...
		switch (this.m) {
			...
			default:
				s1 = java.lang.String.valueOf(this.m);
				break;
		}
		return s1;
	}
	...
	public java.lang.String toString() {
		return new String("type=" + this.a() + ", minWidth=" + this._mthif() + ", precision=" + this._mthdo());
	}
...
class b {
	...
	public b(java.lang.String s) {
		...
		this._fldnew = 0;
		this._fldint = new Vector();
		this._fldfor = new Vector();
	}
		...
		for (boolean flag = false; !flag;)
			if (this.a(37)) {
				if (this.a(37))
					...
					this._mthnull();
					if (!this._flddo) {
						this._fldint.addElement(((this._fldif)));
						this._fldfor.addElement(((s)));
						s = new String();
						this._fldif = null;
					}
				}
			} else if (this._fldnew < this.a.length)
				s = s + this.a[this._fldnew++];
			else {
				this._fldfor.addElement(((s)));
				flag = true;
			}
	...
	private void _mthfor() throws ParseErrorException {
		this._flddo = true;
		throw new ParseErrorException("Parse error. Unknown symbol: " + this.a[this._fldnew]);
	}
	...
	private void _mthnull() throws ParseErrorException {
		this._fldif.m = 0x80000000;
		this._flddo = false;
		if (this._mthnew())
			this._mthtry();
		else if (this._mthgoto())
			this._mthvoid();
		else if (this.a(46))
			this._mthcase();
		else if (this._mthint())
			this._mthlong();
		else
			this._mthfor();
	}
	...
	private int a() {
		if (this._fldnew == this.a.length)
			return -1;
		int i = -1;
		for (boolean flag = false; !flag;)
			if (java.lang.Character.isDigit(this.a[this._fldnew])) {
				if (this._fldnew == this.a.length)
					i = 0;
				if (i == -1)
					i = this.a[this._fldnew] - 48;
				else
					i = 10 * i + (this.a[this._fldnew] - 48);
				if (++this._fldnew == this.a.length)
					flag = true;
			} else
				flag = true;
	...
	private boolean a(int i) {
		if (this._fldnew < this.a.length && this.a[this._fldnew] == i) {
			this._fldnew++;
			return true;
		} else
			return false;
	...
	private boolean _mthint() {
		boolean flag = true;
		if (this.a(99))
			this._fldif._fldbyte = 1;
		else if (this.a(100) || this.a(105))
			this._fldif._fldbyte = 2;
		else if (this.a(117))
			this._fldif._fldbyte = 14;
		else if (this.a(111))
			this._fldif._fldbyte = 3;
		else if (this.a(120)) {
			this._fldif._fldbyte = 4;
			this._fldif._fldelse = 1;
		} else if (this.a(88)) {
			this._fldif._fldbyte = 4;
			this._fldif._fldelse = 2;
		} else if (this.a(101)) {
			this._fldif._fldbyte = 6;
			this._fldif._fldelse = 1;
		} else if (this.a(69)) {
			this._fldif._fldbyte = 6;
			this._fldif._fldelse = 2;
		} else if (this.a(102))
			this._fldif._fldbyte = 8;
		else if (this.a(103)) {
			this._fldif._fldbyte = 9;
			this._fldif._fldelse = 1;
		} else if (this.a(71)) {
			this._fldif._fldbyte = 9;
			this._fldif._fldelse = 2;
		} else if (this.a(115))
			this._fldif._fldbyte = 11;
		else if (this.a(108)) {
			this._fldif._fldbyte = 12;
			this._fldif._fldelse = 1;
		} else if (this.a(76)) {
			this._fldif._fldbyte = 12;
			this._fldif._fldelse = 2;
		} else if (this.a(98)) {
			this._fldif._fldbyte = 13;
			this._fldif._fldelse = 1;
		} else if (this.a(66)) {
			this._fldif._fldbyte = 13;
			this._fldif._fldelse = 2;
...
class a {
	...
	protected static java.lang.String _mthif(double d, int i) {
		...
		stringbuffer.append('.');
		for (int j = 0; j < i; j++)
			stringbuffer.append(java.lang.String.valueOf(((abyte0[j]))));
