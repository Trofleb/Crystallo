...
public class Utils3d {
	...
	public static TransformGroup putAtom(Group parent, float radius, Point3d p, Appearance app, double scale) {
		Sphere s = new Sphere(1, Sphere.GENERATE_NORMALS, 20, app);
	...
	public static BranchGroup createPlan(Point3d p, Vector3d e1, Vector3d e2, Vector3d e3, double w, double h, Appearance app) {
		Transform3D t3d = new Transform3D(); 
	...
	public static BranchGroup createAtom(Point3d p, float radius, Appearance app, int precision) {
		Sphere s = new Sphere(1, Sphere.GENERATE_NORMALS, precision, app);
		Transform3D t3d = new Transform3D();
		t3d.set(radius, new Vector3d(p));
		TransformGroup t = new TransformGroup(t3d);
		t.addChild(s);
	...
	public static Group createLegend(String s, Point3d pos, Point3d rot, float size, Appearance app, boolean centered) {
		...
		Text3D txt = new Text3D(f3d, s, new Point3f(2, 2, 2), centered?Text3D.ALIGN_CENTER:Text3D.ALIGN_FIRST, Text3D.PATH_RIGHT);
	...
	public static BranchGroup createRepere(Color3f colorText, Color3f colorArrows, Color3f colorCenter, String[] names, float sizeText, float sizeArrows, double deltaText, double deltaArrows, Vector3d x, Vector3d y, Vector3d z) {
		...
		if (colorCenter!=null) repere.addChild(new Sphere(sizeArrows, Sphere.GENERATE_NORMALS, 10, createApp(colorCenter)));
	...
	public static BranchGroup createVector(String name, Point3d p, Vector3d v, float size, Appearance app, int precision) {
		BranchGroup bg = new BranchGroup();
		bg.setCapability(BranchGroup.ALLOW_DETACH);
