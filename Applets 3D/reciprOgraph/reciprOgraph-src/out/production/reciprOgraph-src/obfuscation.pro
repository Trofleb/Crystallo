...
-keepclasseswithmembers public class reciprOgraph {
    public static void main(java.lang.String[]);
}

# Keep - Applets. Keep all extensions of MainApp.
-keep public class panes.MainApp {
		<methods>;
}

# Also keep - Bean classes. Keep all bean classes along with their getters
# and setters.
-keep class org.jfree.chart.resources.**, org.jfree.resources.**, org.jfree.data.resources.** {
    void set*(%);
    void set*(**);
    void set*(%[]);
    void set*(**[]);
