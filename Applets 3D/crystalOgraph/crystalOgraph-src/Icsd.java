...
public class Icsd implements ActionListener {
		...
		this.table = new JTable(this.sorter) {
			...
			public String getToolTipText(MouseEvent e) {
				...
				if (realColumnIndex == 1 || realColumnIndex == 2 || realColumnIndex == 4) {
					...
					String sg = (String) this.getModel().getValueAt(rowIndex, 3);
					int no = CellSymetries.getSGno(sg);
					if (no == 0)
						return "Unknown space group !";
					String choice = CellSymetries.getChoice(no, CellSymetries.parseChoice(sg));
					if (choice.length() > 1)
						choice = "(" + choice + ")";
	...
	private static String[] files = { "1913_Hull, W.H.;Bragg, W.L._C_F d -3 m S_Carbon.cif",
	...
	public static void main(String[] args) throws MalformedURLException, IOException, InterruptedException {
		...
		Icsd icsd = new Icsd(null);
		icsd.edit1.setText("c");
		icsd.edit2.setText("1");
		icsd.populateElementList();
		System.out.println(icsd.elementNumber + " " + icsd.lastError);
		for (int i = 0; i < icsd.list.length; i++) {
			System.out.print(i + ": ");
			for (int j = 0; j < icsd.list[i].length; j++)
				System.out.print(icsd.list[i][j] + " ");
			System.out.println();
		}
	}
	...
	public static String between(String s, String a, String b) {
		int p1 = s.indexOf(a);
		if (p1 != -1) {
	...
	public static String right(String s, String a) {
		int p1 = s.indexOf(a);
		if (p1 != -1)
	...
	public static String left(String s, String a) {
		int p1 = s.indexOf(a);
		if (p1 != -1)
