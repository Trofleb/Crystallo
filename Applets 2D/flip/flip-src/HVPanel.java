...
public abstract class HVPanel implements ActionListener {
	...
	public HVPanel() {
		jPanel = new JPanel() {
			public void setVisible(boolean visible) {
				...
				HVPanel.this.setVisible(visible);
			}
		};
	...
	public static class LongEditField extends EditField {
		public LongEditField(String name, String unit, int nbcol, long defValue, NumberFormatter formatter) {
			super(name, unit, nbcol, new Long(defValue), formatter);
		}
		public LongEditField(String name, String unit, int nbcol, long defValue) {
			super(name, unit, nbcol, new Long(defValue), new NumberFormatter(java.text.NumberFormat.getIntegerInstance()));
		}
		public long getLongValue() {
			return Long.parseLong(""+super.getValue());
		}
		public void setValue(long v) {
			super.setValue(new Long(v));
		}
		public void setMaximum(long max) {
			super.setMaximum(new Long(max));
		}
		public void setMinimum(long min) {
			super.setMinimum(new Long(min));
		}
		public LongEditField to(HVPanel p) {
			super.putTo(p);
			this.setListener(p);
			return this;
		}
	...
	public static class IntSpinnerEditField extends IntEditField {
		...
		public IntSpinnerEditField(String name, String unit, int nbcol, int defValue, int step) {
...
//	}
	...
	public static abstract class SliderAndValue implements ChangeListener, MouseWheelListener, ActionListener, PropertyChangeListener {
		...
		public void stateChanged(ChangeEvent e) { 
			//System.out.println(((JSlider)e.getSource()).getValueIsAdjusting());
